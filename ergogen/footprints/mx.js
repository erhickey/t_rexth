...
module.exports = {
  ...
  body: p => {
    ...
    const hotswap_via = p.param.hotswap
        ? `
          (pad 1 thru_hole circle (at 0 -6.7) (size 0.6 0.6) (drill 0.3) (layers *.Cu) (zone_connect 2) ${p.net.to.str})
          (pad 1 thru_hole circle (at 0 4.5) (size 0.6 0.6) (drill 0.3) (layers *.Cu) (zone_connect 2) ${p.net.from.str})
        `
        : '';
    if(p.param.reverse){
      return `
